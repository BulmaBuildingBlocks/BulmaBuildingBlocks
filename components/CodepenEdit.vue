<template>
  <form v-if="hasHtml" method="POST" action="https://codepen.io/pen/define/" target="_blank" rel="noopener">
...
export default {
  ...
  data() {
    return {
      hasHtml: false,
      externalScripts: ['https://unpkg.com/vue/dist/vue.min.js', 'https://unpkg.com/buefy/dist/buefy.min.js'],
      externalStyles: [
