<template>
  <component :is="tag" v-bind="$attrs" class="editor">
    <editor-menu-bar v-slot="{ commands, isActive, focused, getMarkAttrs }" :editor="editor">
      <div class="menubar is-hidden" :class="{ 'is-focused': focused }">
        <form
          v-if="linkMenuIsActive"
          class="field is-marginless is-grouped is-fullwidth"
        ...
        >
          ...
          <div class="control">
            <button class="button is-small is-white" type="button" @click="setLinkUrl(commands.link, null)">
        ...
        <div v-else class="buttons has-addons">
          ...
          <button class="button is-small is-white" :class="{ 'is-active': isActive.italic() }" @click="commands.italic">
            <b-icon pack="fa" icon="italic" />
          </button>

          <button class="button is-small is-white" :class="{ 'is-active': isActive.strike() }" @click="commands.strike">
